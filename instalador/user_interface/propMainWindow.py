...
"border-image: url(:/iconoVacuna/icono vacuna.png);")
        ...
        self.actionConsultarProgramacion = QtWidgets.QAction(PropMainWindow)
        self.actionConsultarProgramacion.setObjectName("actionConsultarProgramacion")
        ...
        self.menuProgramacion_de_vacunacion.addAction(self.actionConsultarProgramacion)
    ...
    def retranslateUi(self, PropMainWindow):
        ...
        self.actionConsultarProgramacion.setText(_translate("PropMainWindow", "Consultar"))
